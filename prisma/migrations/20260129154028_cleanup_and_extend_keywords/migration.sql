...
-- AlterTable
ALTER TABLE `BlogMedia` MODIFY `url` LONGTEXT NOT NULL;

-- AlterTable
ALTER TABLE `BlogPost` MODIFY `content` LONGTEXT NOT NULL,
    MODIFY `contentAr` LONGTEXT NULL,
...
CREATE TABLE `orderitem` (
    ...
    `variantNameSnapshot` VARCHAR(191) NOT NULL,
...
CREATE TABLE `GlobalSeoTranslation` (
    `id` VARCHAR(191) NOT NULL,
    `globalSeoSettingId` VARCHAR(191) NOT NULL,
    `language` ENUM('en', 'ar', 'fr') NOT NULL,
    `siteName` VARCHAR(191) NULL,
    `titleSuffix` VARCHAR(191) NULL,
    `defaultMetaDesc` TEXT NULL,
    `defaultKeywords` TEXT NULL,

    INDEX `GlobalSeoTranslation_globalSeoSettingId_idx`(`globalSeoSettingId`),
    UNIQUE INDEX `GlobalSeoTranslation_globalSeoSettingId_language_key`(`globalSeoSettingId`, `language`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

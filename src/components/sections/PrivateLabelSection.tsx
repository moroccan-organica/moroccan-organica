            ...
            <div className="container-main">
                ...
                <div className="text-center max-w-5xl mx-auto mb-14 animate-fade-in-up">
                    ...
                    <div className="mx-auto space-y-4 text-lg md:text-xl leading-8 text-muted-foreground/90">
                        <p dangerouslySetInnerHTML={{ __html: data.discoverText1 }} />
                        {data.discoverText2 && (
                            <p dangerouslySetInnerHTML={{ __html: data.discoverText2 }} />
                        )}
                        {data.discoverText3 && (
                            <p dangerouslySetInnerHTML={{ __html: data.discoverText3 }} />
                        )}
                    </div>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-10 lg:gap-14 items-start">
                    ...
                    <div className="animate-fade-in-right lg:order-2 flex flex-col justify-start gap-4 lg:pl-6 xl:pl-10 max-w-2xl mx-auto md:mx-0 text-left">
                        <div className="space-y-4 text-muted-foreground/90 leading-7 md:leading-8 max-w-3xl">
                            <p dangerouslySetInnerHTML={{ __html: data.brandText1 }} />
                            {data.brandText2 && (
                                <p dangerouslySetInnerHTML={{ __html: data.brandText2 }} />
                            )}
                            {data.brandText3 && (
                                <p dangerouslySetInnerHTML={{ __html: data.brandText3 }} />
                            )}
                        </div>
                    </div>
                </div>

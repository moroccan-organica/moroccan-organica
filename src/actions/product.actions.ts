...
function transformToShopProduct(product: any, preferredLang: LanguageCode = 'en'): ShopProductDB {
  ...
  return {
    ...
    h1: translation?.h1 || translation?.name || '',
    h1Ar: arTranslation?.h1 || translation?.h1 || arTranslation?.name || translation?.name || '',
    h1Fr: frTranslation?.h1 || translation?.h1 || frTranslation?.name || translation?.name || '',
